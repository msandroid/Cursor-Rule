...
struct LocalizedStringsNew {
    ...
    struct History {
        ...
        static let noHistoryDescription = LocalizedStringResource("Voice recognition history will appear here", comment: "No history description")
        ...
        static let transcription = LocalizedStringResource("Transcription", comment: "Transcription label")
    ...
    struct Settings {
        ...
        static let transcribeDescription = LocalizedStringResource("Transcribe mode: Speech will be converted to text in the original language", comment: "Transcribe mode description")
        static let autoDetectDescription = LocalizedStringResource("Auto-detect mode: Language will be automatically detected from audio", comment: "Auto-detect mode description")
        static let sourceLanguage = LocalizedStringResource("Source Language", comment: "Source language setting")
        static let selectLanguageDescription = LocalizedStringResource("Select the language for speech recognition", comment: "Select language description")
        static let textFontType = LocalizedStringResource("Text Font Type", comment: "Text font type setting")
        static let selectFontDescription = LocalizedStringResource("Select the font family for speech-to-text display", comment: "Select font description")
        static let preview = LocalizedStringResource("Preview", comment: "Preview label")
        static let previewDescription = LocalizedStringResource("This is how your output text will look", comment: "Preview description")
    ...
    // MARK: - Dashboard View
    struct Dashboard {
        static let scribe = LocalizedStringResource("Scribe", comment: "Scribe app name")
        static let yourAnalytics = LocalizedStringResource("Your Analytics", comment: "Your analytics title")
        static let trackTokenUsage = LocalizedStringResource("Track your token usage over time", comment: "Track token usage description")
        ...
        static let chooseBestModel = LocalizedStringResource("Choose the best model for your transcription needs", comment: "Choose best model description")
        ...
        static let scribeCoreDocumentation = LocalizedStringResource("Scribe Core Documentation", comment: "Scribe core documentation title")
        static let viewWhisperkitDocs = LocalizedStringResource("View WhisperKit documentation", comment: "View WhisperKit docs button")
        static let scribeCoreFree = LocalizedStringResource("Scribe Core - Free", comment: "Scribe core free title")
        static let usageAnalytics = LocalizedStringResource("Usage Analytics", comment: "Usage analytics title")
        static let monitorUsage = LocalizedStringResource("Monitor your Scribe Core usage and performance metrics", comment: "Monitor usage description")
        static let usageTrends = LocalizedStringResource("Usage Trends", comment: "Usage trends title")
        static let dailyTranscriptions = LocalizedStringResource("Daily Transcriptions", comment: "Daily transcriptions title")
        ...
        static let billingSubscription = LocalizedStringResource("Billing & Subscription", comment: "Billing subscription title")
        static let betaFreePlan = LocalizedStringResource("Beta version - Free plan with unlimited access", comment: "Beta free plan description")
        static let beta = LocalizedStringResource("BETA", comment: "Beta badge")
        static let betaTestingPhase = LocalizedStringResource("Currently in beta testing phase", comment: "Beta testing phase description")
        ...
        static let understandingTokens = LocalizedStringResource("Understanding tokens and their role in AI transcription", comment: "Understanding tokens description")
        ...
        static let speechRecognitionFeatures = LocalizedStringResource("Speech recognition features and capabilities", comment: "Speech recognition features description")

...
class TokenCalculator: ObservableObject {
    ...
    // OpenAI GPT-4の料金設定（2024年基準）
    private let gpt4InputCostPer1KTokens: Double = 0.03
    private let gpt4OutputCostPer1KTokens: Double = 0.06
    ...
    private func calculateEstimatedCostInBackground() async -> Double {
        ...
        return tokensInThousands * gpt4InputCostPer1KTokens
    }
